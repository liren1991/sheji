(function ($) {
    ...
    var methods = {
        init: function (options) {
            ...
            if (o.prevText) {
                methods._appendItem.call(this, o.currentPage - 1, {text: o.prevText});
            }
            ...
            if (pageIndex == o.currentPage || o.disabled) {
                ...
                if (!(o.currentPage == 0 && options.text == '上一页') && !(o.currentPage == 49 && options.text == '下一页'))
                    $link = $('<span class="page-link">' + (options.text) + '</span>');
            } else {
                $link = $('<span class="page-link">' + (options.text) + '</span>');
                console.log("渲染页数:   " + options.text);
